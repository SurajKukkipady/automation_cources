...
def test_amazon_responsiveness(page: Page, viewport):
    try:
        ...
        #page.screenshot(path="screenshothomepage.png", full_page=True)
        page.screenshot(path=f"screenshot_{viewport['name'].lower()}.png", full_page=True)
        ...
        #page.screenshot(path="screenshot_results.png", full_page=True)
        page.screenshot(path=f"screenshot_results_{viewport['name'].lower()}.png", full_page=True)
